...
public class ProductCheckController {
    ...
    Response<Integer> check(@Valid @RequestBody SimpleRequest request,
        ...
        //3. 检测当前模块有无启用
        BizResponse<JPLC> jplcBizResponse = systemMTService.getWorkFlow(sf01.JPBH, 6);
        ...
        //5. 执行摆药核对操作
        BizResponse<Integer> bizResponse1 = sfmtService.action(jlxh, time, ygdm, ActionType.PRODUCT_CHECK,sf01.ZTBZ);
